      ...
      link: function(scope, element, attrs, ngModel) {
        ...
        ngModel.$render = function() {
          ...
          if (mv === null || mv === undefined || mv === "") {
            element.addClass('dn-data-placeholder');
          } else {
            element.html(ngModel.$modelValue);
          }
        };

        // On focus remoe the placeholder class
        element.bind('focus', function() {
          element.removeClass('dn-data-placeholder');
        });
        ...
        // Write user input data to the model
        function read() {
...
// Directive Develops the list of user name
    ...
    .directive('mentioMenu', function (mentioUtil, $rootScope, $log, $window, $document) {
        return {
            ...
            templateUrl: function(tElement, tAttrs) {
                return tAttrs.mentioTemplateUrl !== undefined ? tAttrs.mentioTemplateUrl : 'mentio-menu.html';
            },
